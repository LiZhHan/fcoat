function [slm_corf,slm_int] = slmcoatProB(N_sub, N, M, I1, slm_cor)

% N the size of the matrix returned
% M SLM size
% N_sub number of SLM segments
% I1 The light intensity sequence obtained at the first half of the desired point
...
% The previous half replaces the angle calculated in the previous step
F = fft(I1);   % Fourier transform, 0 ~ Fs-df, -Fs ~ -df
